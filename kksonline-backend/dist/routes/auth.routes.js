 ...
 * @access  Public
 */
router.post('/google', validate({ body: schemas.googleAuth }), asyncHandler(async (req, res) => {
 ...
 * @access  Public
 */
router.post('/refresh', validate({ body: schemas.refreshToken }), asyncHandler(async (req, res) => {
